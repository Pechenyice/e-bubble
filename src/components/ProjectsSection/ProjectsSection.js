...
function ProjectsSection() {
  ...
  let [projects, setProjects] = useState({
    list: [
      ...
      },
      {
        ...
        type: 'Service',
        status: 'Development',
        briefly: 'Web Service for sharing businesses',
        graph: [
          {
            name: 'JS',
            percent: 94,
        ...
        link: {
          href: 'https://github.com/Pechenyice/diplomWeb',
          icon: faGithub,
        },
      },
    ],
        ...
        let newProjects = projects.list.map((p) => {
          if (p.active) {
            ...
            return Object.assign({}, p, {
              img: { path: p.img.path, active: newActive, content: p.img.content },
            });
          } else return p;
        });
  ...
  return (
    <div className="app__projectsWrapperBox">
      <div
        className="app__projectsWrapper"
        style={{
              ...
              <div className="projects__projectInfo">
                <div>
                  ...
                  <div className="projects__projectTechs projectTechs">
                    {projects.list.map((p) => {
                      if (p.active) {
                        return p.graph.map((g, j) => (
                          <ProjectsTech key={j} name={g.name} percent={g.percent} color={g.color} />
                        ));
                      }
                    })}
                ...
                <div className="projects__projectGallery">
                  ...
                  <div className="projects__projectsGalleryControllerWrapper">
                    <div
                      className="projects__projectsGalleryController"
                      onClick={handleSwapImg(-1)}
                    >
                      <FontAwesomeIcon icon={faChevronLeft} />
                    </div>
                    <div className="projects__projectsGalleryController" onClick={handleSwapImg(1)}>
                    ...
                    <div className="doughnut__doughnutProjector galleryProjector">
                      ...
                      <svg
                        className="doughnut__doughnutProjectorRays"
                        ref={prRays}
                        width="134"
                        height="111"
                        viewBox="0 0 134 111"
                    ...
                    {projects.list.map((p) => {
                      if (p.active) {
                        return (
                          <a
                            className="projects__projectLinkWrapper"
                            target="_blank"
                            href={p.link.href}
                          >
                            <div className="projects__projectLink">
                              <span className="projects__projectBackground" ref={prLink}>
                                <FontAwesomeIcon icon={p.link.icon} />
                              </span>
                            </div>
                            <p className="projects__projectLinkText">link</p>
                          </a>
                        );
                      }
                    })}
