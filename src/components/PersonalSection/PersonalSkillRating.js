...
function PersonalSkillRating({rating, name}) {
    ...
    return (
        ...
        <div className='isometric__skill'>
            <div className='isometric__skillAnim' style={{left: '-30px'}}><FontAwesomeIcon icon={faChevronRight} /></div>
            ...
            <div className='isometric__skillAnim' style={{right: '-30px'}}><FontAwesomeIcon icon={faChevronLeft} /></div>
        </div>
