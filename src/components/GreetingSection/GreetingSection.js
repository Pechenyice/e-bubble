...
function GreetingSection() {
    ...
    techs: [
      {
        tech: 'JavaScript',
        text: (
          <p className="hintBox__text">
            <h6>JavaScript</h6>Started learning JS <span className="greeting__accent">3 years</span>{' '}
            ago. Now I am confidently writing <span className="greeting__accent">"vanilla" JS</span>{' '}
            and starting look for suitable framework
          </p>
        ),
        display: false,
        activeColor: '#E8FC04',
      ...
      },
      {
        ...
        text: (
          <p className="hintBox__text">
            <h6>React</h6>This <span className="greeting__accent">page is written with React</span>!
            Now it is <span className="greeting__accent">my main choice</span> between JS frameworks
          </p>
        ),
        display: false,
        activeColor: '#61DBFB',
      ...
      },
      {
        ...
        text: (
          <p className="hintBox__text">
            <h6>Node.js</h6>Awesome runtime.{' '}
            <span className="greeting__accent">2 of 3 years use this platform</span> for all
            fullstack projects
          </p>
        ),
        display: false,
      ...
      },
      {
        ...
        text: (
          <p className="hintBox__text">
            <h6>HTML + CSS</h6>Nothing interesting. Markup language and styles sheet are web base.
            Trying to be modern for <span className="greeting__accent">5 years</span> in a row
          </p>
        ),
        display: false,
        activeColor: '#F06529',
      ...
      },
      {
        ...
        text: (
          <p className="hintBox__text">
            <h6>Electron.js</h6>Very <span className="greeting__accent">interesting for me</span>{' '}
            framework. I don't think it is useful for me every day, but it{' '}
            <span className="greeting__accent">makes writing desktops fun and easy</span>
          </p>
        ),
        display: false,
        activeColor: '#9FEAF9',
      ...
      },
      {
        ...
        text: (
          <p className="hintBox__text">
            <h6>Figma</h6>Look at this{' '}
            <span className="greeting__accent">
              <span className="greeting__accentJoke">pretty</span> design
            </span>
            . I think Figma will want to disown it, but it is{' '}
            <span className="greeting__accent">created in this tool</span>
          </p>
        ),
        display: false,
        activeColor: '#FF7765',
      ...
      },
      {
        ...
        text: (
          <p className="hintBox__text">
            <h6>SQL/NoSQL</h6>select * from knowings;
            <br />
            <span className="greeting__accent">Empty set</span> (0.00 sec)
            <br />
            <br />
            Oh...
          </p>
      ...
      },
      {
        ...
        text: (
          <p className="hintBox__text">
            <h6>Git</h6>init -{'>'} remote -{'>'} add -{'>'} commit -{'>'} push <br />
            <br /> Not all, but <span className="greeting__accent">99%</span> ;)
          </p>
        ),
        display: false,
        activeColor: '#F1502F',
          ...
          <g>
            <mask id="path-3-inside-2" fill="white">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M177.171 68.6295C128.812 90.32 89.8719 129.26 68.1813 177.619L23.2441 158.545C49.8811 98.5745 98.1263 50.3291 158.096 23.6921L177.171 68.6295Z"
              />
            </mask>
          ...
          <g>
            <mask id="path-9-inside-5" fill="white">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M530.293 266C530.293 301.25 523.411 334.893 510.917 365.659L465.979 346.584C475.987 321.68 481.495 294.483 481.495 266C481.495 237.34 475.919 209.983 465.793 184.954L510.729 165.88C523.342 196.77 530.293 230.573 530.293 266Z"
              />
            </mask>

            <path
              d="M510.917 365.659L510.588 366.433L511.375 366.767L511.696 365.975L510.917 365.659ZM465.979 346.584L465.199 346.27L464.891 347.036L465.651 347.358L465.979 346.584ZM465.793 184.954L465.464 184.179L464.703 184.503L465.013 185.269L465.793 184.954ZM510.729 165.88L511.508 165.562L511.185 164.772L510.4 165.105L510.729 165.88ZM511.696 365.975C524.23 335.111 531.134 301.361 531.134 266H529.451C529.451 301.14 522.591 334.676 510.137 365.342L511.696 365.975ZM465.651 347.358L510.588 366.433L511.246 364.884L466.308 345.809L465.651 347.358ZM480.653 266C480.653 294.374 475.167 321.464 465.199 346.27L466.76 346.898C476.807 321.896 482.336 294.592 482.336 266H480.653ZM465.013 185.269C475.099 210.2 480.653 237.45 480.653 266H482.336C482.336 237.23 476.739 209.766 466.573 184.638L465.013 185.269ZM510.4 165.105L465.464 184.179L466.122 185.728L511.058 166.654L510.4 165.105ZM531.134 266C531.134 230.462 524.161 196.551 511.508 165.562L509.95 166.198C522.522 196.989 529.451 230.684 529.451 266H531.134Z"
              fill="#3C873A"
  ...
  function handleNewRandHint() {
    ...
    setDreams({
      techs: dreams.techs.map((t, i) =>
        i == newCurrent
          ? { tech: t.tech, text: t.text, display: true, pos: t.pos, activeColor: t.activeColor }
          : { tech: t.tech, text: t.text, display: false, pos: t.pos, activeColor: t.activeColor }
      ),
    });
    setAutoShow({
      isActive: true,
      current: newCurrent,
      timer: setTimeout(handleNewRandHint, 5000),
    });
  }
  ...
  function startGreetingAnimation() {
    ...
    for (
      let i = 1;
      i <= document.getElementsByClassName('doughnut__headingAnimation').length;
      i++
    ) {
      i > 4
        ? setTimeout(() => {
            document.getElementsByClassName(`doughnut__headingAnimation_${i}`)[0].style.opacity = 1;
          }, 100 + i * 400)
        : setTimeout(() => {
            document.getElementsByClassName(`doughnut__headingAnimation_${i}`)[0].style.opacity = 1;
          }, 100 + i * 300);
    ...
    setTimeout(() => {
      document.getElementsByClassName('smallScreenAdvice')[0].style.opacity = '1';
    }, 4000);
    setTimeout(() => {
      document.getElementsByClassName('app__greetingWrapperBox')[0].style.pointerEvents = 'auto';
    }, 4300);
  }

  function handleDoughnutIconHover(name) {
    let newDreams = dreams.techs.map((t) =>
      t.tech === name
        ? { tech: t.tech, text: t.text, display: true, pos: t.pos, activeColor: t.activeColor }
        : { tech: t.tech, text: t.text, display: false, pos: t.pos, activeColor: t.activeColor }
    );
  ...
  return (
    <div className="app__greetingWrapperBox" style={{ perspective: '10000px' }}>
      <div
        className="app__greetingWrapper"
        style={{ transform: 'translateZ(0px)', transition: '1s' }}
      >
          ...
          <div className="greeting__graph graph">
            <div className="graph__doughnut doughnut">
              <div className="doughnut__doughnutProjector">
                ...
                <svg
                  className="doughnut__doughnutProjectorRays doughnut__headingAnimation doughnut__headingAnimation_6"
                  width="134"
                  height="111"
                  viewBox="0 0 134 111"
                  fill="none"
              ...
              <div className="doughnut__proection">
                <DoughnutList
                  dreams={dreams}
                  onHover={handleDoughnutIconHover}
                  onLeave={handleDoughnutIconLeave}
                />

                <svg
                  className="doughnut__headingAnimation doughnut__headingAnimation_7"
                  width="531"
                  height="531"
                  viewBox="0 0 531 531"
                  fill="none"
                      ...
                      <g key={i}>
                        {[
                          ...
                          <path
                            ...
                            d={s.path}
                            onMouseEnter={() => {
                              handleDoughnutIconHover(s.tech);
                            }}
                            onMouseLeave={() => {
                              handleDoughnutIconLeave(s.tech);
                            }}
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            fill={s.activeColor}
                ...
                {dreams.techs.map((t, i) => (
                  <GreetingTechHint
                    key={i}
                    pos={t.pos}
                    name={t.tech}
                    text={t.text}
                    opacity={t.display ? 1 : 0}
                  />
                ))}
              </div>
            ...
            <div className="isometricTextBox__mainTextBox">
              <h1 className="doughnut__heading">
                <span className="doughnut__headingWrapper">
                  <span className="doughnut__headingAnimation doughnut__headingAnimation_1">
                    Hello,
                  </span>{' '}
                  <span className="doughnut__headingAnimation doughnut__headingAnimation_2">
                    I’m
                  </span>
                  <br />
                  <span className="greeting__accent doughnut__bigHeading doughnut__headingAnimation doughnut__headingAnimation_3">
                    German Iskhakov
                  </span>
                  <br />
                  <span className="doughnut__headingAnimation doughnut__headingAnimation_4">
                    the <span className="greeting__accent">web developer</span>
                  </span>
                </span>
              </h1>
              ...
              <div className="smallScreenAdvice">
                <div className="smallScreenAdvice__text">
                  <p>
                    ...
                    <br />
                    recommended bigger screen
                  </p>
                </div>
                <div className="smallScreenAdvice__list">
                  <SmallScreenAdviceExample
                    styles={{ width: '80px', height: '70px', fontSize: '16px' }}
                    defaultSize={`${window.innerWidth}x${window.innerHeight}`}
                    shouldScan={true}
                    name="Current"
                  />
                  <SmallScreenAdviceExample
                    styles={{ width: '100px', height: '90px' }}
                    defaultSize="1150x650"
                    name="Target"
                  />
                </div>
              </div>
